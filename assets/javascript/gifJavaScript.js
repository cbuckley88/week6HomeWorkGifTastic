...
//array of characters
    var characters = ["University of Richmond", "Dave Chappelle", "Marc Brownstein",  "millhouse", "Moe Szyslak", "Macho Man", "chocolate", "Dug"];
...
//renders character buttons
    ...
    $("#buttons-view").on("click", ".btn-primary", function() {
        ...
        //API calls returns 15 repsonses only 1 loads...
